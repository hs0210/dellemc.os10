...
class TestDellos10ConfigModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.dellemc.os10.plugins.modules.os10_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.dellemc.os10.plugins.modules.os10_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.dellemc.os10.plugins.modules.os10_config.run_commands')
